...
class LoadDatabase {
  ...
  CommandLineRunner initDatabase(UserRepository repository, 
    ...
    return args -> {
      log.info("Preloading " + transactionLimitRepository.save(new TransactionLimit(UserType.PF, 10000.0)));
      log.info("Preloading " + transactionLimitRepository.save(new TransactionLimit(UserType.PJ, 50000.0)));
